...
REPO="https://github.com/bitc-ticker/btc-ticker"
...
safedir=$(realpath ./ci/armhf-rpi/packer-builder-arm)
...
echo "# BTC-Ticker Version: ${codeVersion}"
...
if [ "${ARCH}" == "arm" ] && [ "${TYPE}" == "min" ]; then
  PACKERTARGET="armhh-rpi-lean-image"
  PACKERBUILDPATH="./btc-ticker/ci/armhf-rpi/packer-builder-arm/btc-ticker-armhf-rpi-lean.img"
  PACKERFINALFILE="btc-ticker-min-v${codeVersion}-${dateString}.img"
elif [ "${ARCH}" == "arm" ] && [ "${TYPE}" == "fat" ]; then
  PACKERTARGET="armhf-rpi-fatpack-image"
  PACKERBUILDPATH="./btc-ticker/ci/armhf-rpi/packer-builder-arm/btc-ticker-armhf-rpi-fat.img"
  PACKERFINALFILE="btc-ticker-fat-v${codeVersion}-${dateString}.img"
else
